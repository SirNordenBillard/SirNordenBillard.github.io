...
<div class="d-flex flex-column align-items-center">
  <img src="/assets/img/posts/Underhåndsspids.png" class="w-100 shadow rounded" alt="Illustration af den beskrevne underhåndsspids">
  <em class="d-block text-center mt-2 text-muted">
    Illustration af den beskrevne underhåndsspids.
  </em>
</div>    
...
{% include embed/youtube.html id='5l__wnW80bg' %}
{: .mt-4 }

Mobil-venlig version kan findes ved at [TRYKKE HER](https://www.youtube.com/shorts/5l__wnW80bg)
...
<div class="d-grid gap-2 col-md-8 mx-auto mt-5">
  <a href="https://www.facebook.com/SirNordenBillard/posts/pfbid034Gu15FyqXrN6XSyihHfsSJYXC2KPo3LM6UCfHsYN5yu7Gh4qL12z6hSR94s7aUi3l" class="btn btn-outline-primary shadow-sm rounded-pill" target="_blank" rel="noopener">
