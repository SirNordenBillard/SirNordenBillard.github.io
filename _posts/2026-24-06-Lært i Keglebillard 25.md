...
For det første skal vi lige have en ting klart: Vi skal ramme keglerne, og vi skal ramme præcist. Der er kun den ene chance, når vi skal støde blødt. Men der har jeg tilfældigvis noget, der kan [hjælpe](/posts/Fjerdedel-systemet-til-langbal)!

<div class="d-flex flex-column align-items-center">
  <img src="/assets/img/posts/Blød-langbal.png" class="w-100 shadow rounded" alt="Illustration af eksempel på den beskrevne bløde langbal.">
  <em class="d-block text-center mt-2 text-muted">
    Illustration af eksempel på den beskrevne bløde langbal.
  </em>
</div>
...
{% include embed/youtube.html id='WoNs6ObCU3A' %}
{: .mt-4 }

Mobil-venlig version kan findes ved at [TRYKKE HER](https://www.youtube.com/shorts/WoNs6ObCU3A)
...
Det var ugens dessin. Skal vi ikke lige få gjort den bløde langbal til noget, der bliver spillet lidt oftere? Det er nemlig et så lækkert dessin - både når det lykkes for en selv, men også for tilskuerne, der sidder og ser på. Det signalerer man har fuldstændig kontrol over spillet!
...
<div class="d-grid gap-2 col-md-8 mx-auto mt-5">
  <a href="https://www.facebook.com/SirNordenBillard/posts/pfbid02A2UN4PRSvHxHxxztoZNPTgEV3sq36aowuigbdVc6wVRkZuDppZuGHj99o4xHooMYl" class="btn btn-outline-primary shadow-sm rounded-pill" target="_blank" rel="noopener">
